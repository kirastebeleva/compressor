...
export const compressImageForEmailPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Email Attachments Online (Free Fast)", description: "For Gmail, Outlook, and client replies, compress images for email online to avoid attachment errors. Keep files clear with quick results and no signup required." },
...
export const compressImageForWebsitePage: PageConfig = {
  ...
  meta: { title: "Compress Image for Website Speed Online (Free Fast)", description: "Improve website load time by compressing images online before publishing to blogs, stores, and landing pages. Keep quality strong with quick local processing." },
...
export const compressImageForInstagramPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Instagram Uploads (Free Fast Online)", description: "Get Instagram-ready files by compressing images online before posting stories or feed content. Keep visuals sharp, reduce upload size, and finish in seconds." },
...
export const compressImageForWhatsappPage: PageConfig = {
  ...
  meta: { title: "Compress Image for WhatsApp Sharing (Fast Free Online)", description: "For WhatsApp chats and group sharing, compress images online to reduce size and improve load speed. Keep results clear while saving mobile data on uploads." },
...
export const compressImageForShopifyPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Shopify Product Pages (Free Fast)", description: "Compress Shopify product images online to speed up catalog, collection, and hero pages. Keep product visuals crisp and publish faster with no account needed." },
...
export const compressImageForDiscordPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Discord Upload Limits (Free Fast)", description: "Stay within Discord upload limits by compressing images online before sharing in channels. Great for screenshots, memes, and server posts with instant results." },
...
export const compressImageForLinkedinPage: PageConfig = {
  ...
  meta: { title: "Compress Image for LinkedIn Posts Online (Free Fast)", description: "Compress images for LinkedIn online so feed posts and article covers load faster while staying professional. Ideal for company updates and branding content." },
