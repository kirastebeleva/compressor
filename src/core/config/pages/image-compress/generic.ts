...
export const freeImageCompressorPage: PageConfig = {
  ...
  meta: { title: "Use Free Image Compressor Online with No Signup (Fast)", description: "Shrink image file size online without visible quality loss for email, websites, and uploads. No signup, no install, and it runs directly in your browser." },
...
export const onlineImageCompressorPage: PageConfig = {
  ...
  meta: { title: "Compress Images Online for Quick Uploads (Free Fast)", description: "Compress images online for quicker uploads across web pages, social media, and forms. Get smaller files in seconds with local processing and no account needed." },
