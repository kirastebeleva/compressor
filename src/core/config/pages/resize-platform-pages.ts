...
export const resizeImageForInstagramPostPage = buildResizePlatformPage(
  ...
  "For Instagram feed content, resize images online with square, portrait, and landscape presets. Get clean framing fast and publish without manual resizing work.",
...
export const resizeImageForInstagramProfilePage = buildResizePlatformPage(
  ...
  "Resize image for Instagram profile online to 320x320 with centered output for avatars and brand pages. Keep faces and logos clear with quick browser processing.",
...
export const resizeImageForFacebookPage = buildResizePlatformPage(
  ...
  "Resize image for Facebook online with presets for posts, covers, stories, and profiles. Keep visuals sharp across devices and export in seconds in your browser.",
...
export const resizeImageForLinkedinPage = buildResizePlatformPage(
  ...
  "Resize image for LinkedIn online with exact sizes for posts, banners, profiles, and logos. Built for professional branding with quick results and no install.",
...
export const resizeImageForTwitterPage = buildResizePlatformPage(
  ...
  "Resize image for Twitter online with one-click presets for posts, headers, and profile photos. Create clean, publish-ready visuals quickly in your browser.",
...
export const resizeImageForYoutubeThumbnailPage = buildResizePlatformPage(
  ...
  "Resize image for YouTube thumbnail online to 1280x720 for crisp video previews. Ideal for creators and channel uploads, with quick processing and easy exports.",
...
export const resizeImageForYoutubeBannerPage = buildResizePlatformPage(
  ...
  "Resize image for YouTube banner online to 2560x1440 for clean channel art across devices. Great for branding refreshes, launches, and profile updates.",
...
export const resizeImageForShopifyPage = buildResizePlatformPage(
  ...
  "Resize image for Shopify online with product, collection, and banner presets. Keep store visuals consistent and sharp while preparing assets quickly for upload.",
...
export const resizeImageForWhatsappPage = buildResizePlatformPage(
  ...
  "Resize image for WhatsApp online for profile and status formats in daily chats and business updates. Get instant results and cleaner uploads in your browser.",
...
export const resizeImageForDiscordPage = buildResizePlatformPage(
  ...
  "Resize image for Discord online with exact icon and banner dimensions for clean server branding. Ideal for communities and team spaces, with quick processing.",
