...
export const freeImageCompressorPage: PageConfig = {
  ...
  meta: { title: "Use Free Image Compressor Online with No Signup (Fast)", description: "Compress JPG, PNG, and WebP images at no cost. Everything runs in your browser — private and instant." },
...
export const onlineImageCompressorPage: PageConfig = {
  ...
  meta: { title: "Compress Images Online for Quick Uploads (Free Fast)", description: "Compress images online without installing software. Works on any device with a modern browser." },
