...
export const compressImageForEmailPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Email Attachments Online (Free Fast)", description: "Make images small enough for email attachments. Processed in your browser — no upload to any server." },
...
export const compressImageForWebsitePage: PageConfig = {
  ...
  meta: { title: "Compress Image for Website Speed Online (Free Fast)", description: "Speed up your site with lighter images. Browser-based compression with no server uploads required." },
...
export const compressImageForInstagramPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Instagram Uploads (Free Fast Online)", description: "Get images ready for Instagram without losing quality. Quick, private, browser-based compression." },
...
export const compressImageForWhatsappPage: PageConfig = {
  ...
  meta: { title: "Compress Image for WhatsApp Sharing (Fast Free Online)", description: "Make images lighter for WhatsApp sharing. Processed locally in your browser — fast and secure." },
...
export const compressImageForShopifyPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Shopify Product Pages (Free Fast)", description: "Speed up your Shopify store with compressed product images. Free, browser-based, no account needed." },
...
export const compressImageForDiscordPage: PageConfig = {
  ...
  meta: { title: "Compress Image for Discord Upload Limits (Free Fast)", description: "Fit images within Discord upload limits. Browser-based compression, free, no login required." },
...
export const compressImageForLinkedinPage: PageConfig = {
  ...
  meta: { title: "Compress Image for LinkedIn Posts Online (Free Fast)", description: "Prepare images for LinkedIn posts and articles. Free browser compression — no uploads to our servers." },
