...
export const metadata: Metadata = {
  ...
  description:
    "Read Imgloo privacy policy to understand how local browser processing protects your files. Includes details for web, email, and social media upload scenarios.",
  alternates: {
