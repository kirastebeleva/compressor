...
export const compressImageBatchPage: PageConfig = {
  ...
  meta: { title: "Batch Compress Images for Bulk Uploads Online (Free)", description: "Batch compress images online to prepare many files for catalogs, blog sets, and social uploads. Save time with quick processing and consistent quality output." },
  ...
  seoContent: { blocks: [
    ...
    { id: "batch-limits", title: "Limits and supported formats", paragraphs: ["Each batch can include up to 20 files totaling 25 MB. Supported formats are JPG, PNG, and WebP.", "Every file is compressed independently using the selected preset."] },
  ] },
  faq: { title: "Frequently Asked Questions", items: [
    { question: "How many images can I compress at once?", answer: "The batch tool supports up to 20 images at a time, with a total limit of 25 MB across all files." },
    ...
    { question: "Can I download all results at once?", answer: "Yes. When you compress 2 or more images, a Download All as ZIP button appears so you can grab everything in one click." },
  ] },
};
